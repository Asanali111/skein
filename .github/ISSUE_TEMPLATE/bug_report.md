...
<!-- Numbered steps. If possible, the smallest standalone command sequence
that triggers it. -->
...
- MCP client(s) connected: <!-- Claude Code, Cursor, etc. -->

## Notes

<!-- Anything else — guesses, things you've ruled out, screenshots. -->
