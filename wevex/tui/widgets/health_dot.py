...
Renders ``Wevex · <scope> · ◉ daemon: <status> · <chunks> chunks · <frags> frags``.
Lives across all screens; refreshed by ``WevexApp``'s periodic worker.
"""
...
class HealthHeader(Static):
    ...
    def render(self) -> Text:
        ...
        text = Text()
        text.append("Wevex", style="bold #d97757")
