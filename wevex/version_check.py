...
more than 2 s, and caches the result so repeated `wevex status` calls
don't hammer PyPI.
"""
...
_PYPI_URL = "https://pypi.org/pypi/wevex/json"
...
def _current_version() -> str:
    try:
        ...
        return version("wevex")
    except Exception:
        pass
    try:
        from wevex import __version__
        return __version__
    except Exception:
        return "0.0.0"
